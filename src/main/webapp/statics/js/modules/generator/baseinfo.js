...
var vm = new Vue({
	...
	methods: {
		...
		saveOrUpdate: function (event) {
			var url = vm.baseInfo.id == null ? "baseinfo/save" : "baseinfo/update";
			$.ajax({
				type: "POST",
			    url: baseURL + url,
		...
		getInfo: function(id){
			$.get(baseURL + "baseinfo/info/"+id, function(r){
                vm.baseInfo = r.baseInfo;
            });
		},
